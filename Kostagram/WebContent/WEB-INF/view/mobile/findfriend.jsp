	...
	<div id="loginform" data-role="page" data-theme="e">
		...
		<div data-role="content">
			<form id="joinForm" method="post" action="#" align="center">
				팔로우할 연락처 찾기 누가 Kostagram을 사용 중인지<br> 확인하고 원하는 친구를 선택하여 팔로우해보세요.
				<div data-role="fieldcontain">
					<center>
						<input type="button" value="연락처 검색" data-inline="true"
							onclick="numbersearch()" /><br>
						<br> 회원 가입시 입력하셨던 전화번호로 서버에 저장됩니다.<br>
					</center>
				</div>
			</form>
		</div>
