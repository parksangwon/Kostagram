...
<%
	String input_hashtag = (String)request.getAttribute("hashtag");
	System.out.println("VIEW input_hashtag = " + input_hashtag);
%>
...
<body>
	<div id="search_result" data-role="page" data-theme="a">
		<input type="hidden" name="hashtag" value="<%= input_hashtag %>"/>
