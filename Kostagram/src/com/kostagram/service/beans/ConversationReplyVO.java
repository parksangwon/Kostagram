...
public class ConversationReplyVO {
	...
	public ConversationReplyVO(String seq_cvs, String from_email, String to_email, String reg_ip, Date reg_time,
			String status) {
		super();
	...
	public String toString() {
		return "ConversationReplyVO [seq_cvs=" + seq_cvs + ", from_email=" + from_email + ", to_email=" + to_email
